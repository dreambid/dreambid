...
/* 드림비드 랜딩 페이지 — 역경매 메커니즘 소개 및 진입 경로 안내 */
      ...
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link href="/seller/login" className="text-sm text-gray-600 hover:text-blue-600">판매자 입장</Link>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <Link href="/seller/login" className="group rounded-2xl border-2 border-green-100 bg-white p-8 shadow-sm transition-all hover:border-green-400 hover:shadow-md">
              <div className="mb-4 text-4xl">🏪</div>
              ...
              <span className="text-sm font-medium text-green-600 group-hover:underline">판매자 대시보드 →</span>
            </Link>
