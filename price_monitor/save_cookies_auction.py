"""옥션 Cloudflare 봇 인증 브라우저 프로필 초기화 스크립트

headless=False로 브라우저를 열어 사용자가 직접 봇 확인을 통과하면
Chromium 프로필(browser_profile_auction/)이 자동 저장된다.

저장된 프로필은 scraper.py에서 headless=False로 재사용한다.
"""
import asyncio
import os
...
PROFILE_DIR = Path(os.path.dirname(__file__)) / "browser_profile_auction"

TARGET_URL = "https://itempage3.auction.co.kr/DetailView.aspx?ItemNo=E901635070"
